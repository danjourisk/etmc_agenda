...
\def\firstspeakername{Yanping Dang}\def\firstspeakerproject{CC6}\def\firstspeakertitle{Really Long Long Title of a Speech in Toastmasters Conference but agenda tex programe and handle it wonderfully}
...
\def\theme#1 {%
\medskip
%\line{\titlefont \hfil Today's Theme\thinspace:\thinspace#1\hfil}%        
...
our club, please contact VPM via \underbar{{\blue huan.liu@ericsson.com}}.
...
%        &\hbox to .35\hsize{\ #\hfil}%           % Conference Session
        &\hbox to .35\hsize{\vtop{\noindent\overfullrule 0pt\hsize .35\hsize#}}%           % Role
