...
%% Meeting Roles
\def\tmname{Liyu Huang}\def\tmproject{CL5}
\def\gename{Jie Zhang}\def\geproject{CL8}
\def\timername{Xiao Qin}\def\timerproject{CL4}
\def\gramname{Amy Wang}\def\gramproject{CL3}
\def\ahname{Fangfang Liu}\def\ahproject{CL1}
\def\ttmname{Rose Zheng}\def\ttmproject{CL4}
\def\ttename{Melanie Wang}\def\tteproject{CL3}
\def\firstspeakername{Yanping Dang}\def\firstspeakerproject{CC6}\def\firstspeakertitle{Reason}
\def\secondspeakername{Huan Liu}\def\secondspeakerproject{CC4}\def\secondspeakertitle{Yoga and me}
\def\firstevaluatorname{Xiao Qin}\def\firstevaluatorproject{CL1}
\def\secondevaluatorname{Xuefeng Wang}\def\secondevaluatorproject{CL1}
...
\smallskip
\line{\hbox to .7in{\quad Time\hfil}\bf#1\quad#2\hfil}%
\smallskip
}
...
\def\venue#1 {%
\smallskip
\line{\hbox to .7in{\quad Venue\hfil}\bf#1\hfil}%
\smallskip
}
...
\vskip .1\vsize
\centerline{\subsubtitlefont A fantastic journey is about to begin...}
