...
\def\themeinfo{Asking Questions}
\def\dateinfo{Feb 19th, 2016}
...
%% function role
\def\tmname{Yanping Dang}     \def\tmproject{CL8}       % Toastmaster   
\def\gename{Yuki Wang}        \def\geproject{CL10}        % General Evaluator
\def\timername{Wanshu Guo}    \def\timerproject{CL4}     % Timer
\def\gramname{Yongming Sun}   \def\gramproject{CL3}      % Grammarian
\def\ahname{Amy Wang}         \def\ahproject{CL1}        % Ah Counter
\def\ttmname{Huan Liu}        \def\ttmproject{CL7}       % Table Topic Master
\def\ttename{Lillian Xue}     \def\tteproject{CL8}       % Table Topic Evaluator

% Evaluator Role

\def\evaonename{Chen Huang}   \def\evaoneproject{CL3}    % Speech Evaluator 1
\def\evatwoname{Cory Wang}     \def\evatwoproject{CL1}    % Speech Evaluator 2
\def\evathreename{Bingfeng Liu} \def\evathreeproject{CL8}  % Speech Evaluator 3
...
% Speaker One
\def\spkonename{Charles Li}      
\def\spkoneproject{ACB4}
\def\spkonetitle{Unique}
\def\spkoneduration{5--7 min}  
\def\spkonetime{07:00}          % {min:sec}, e.g. 8min30sec type {08:30}  

% Speaker Two
\def\spktwoname{Fangfang Liu}   
\def\spktwoproject{CC3}
\def\spktwotitle{The Spring Festival of 2016}
\def\spktwoduration{5--7 min}  
\def\spktwotime{07:00}          % {min:sec}, e.g. 8min30sec type {08:30}  

% Speaker Three
\def\spkthreename{Xinsi Zhao} 
\def\spkthreeproject{CC1}
\def\spkthreetitle{I Love English}
\def\spkthreeduration{4--6 min}  
\def\spkthreetime{06:00}        % {min:sec}, e.g. 8min30sec type {08:30}  
